...
type Token struct {
	...
	ResourceUrn string    `boil:"resource_urn" json:"resource_urn" toml:"resource_urn" yaml:"resource_urn"`
...
var TokenTableColumns = struct {
	...
	ID:          "tokens.id",
	ResourceUrn: "tokens.resource_urn",
	Token:       "tokens.token",
...
var TokenWhere = struct {
	...
	ResourceUrn: whereHelperstring{field: "\"tokens\".\"resource_urn\""},
	Token:       whereHelperstring{field: "\"tokens\".\"token\""},
	CreatedAt:   whereHelpertime_Time{field: "\"tokens\".\"created_at\""},
	LastUsedAt:  whereHelpernull_Time{field: "\"tokens\".\"last_used_at\""},
...
var (
	tokenAllColumns            = []string{"id", "resource_urn", "token", "created_at", "last_used_at", "deleted_at"}
	tokenColumnsWithoutDefault = []string{"resource_urn", "token", "created_at"}
	tokenColumnsWithDefault    = []string{"id", "last_used_at", "deleted_at"}
